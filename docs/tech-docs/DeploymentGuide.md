...
Description automatically generated](data:image/png;base64...)![A screenshot of a group survey
...
2. ![A screenshot of a computer
   ...
   Description automatically generated](data:image/png;base64...)**Search for App Registrations**: Use the search bar to find "App Registrations" and click on it.
...
1. **Add the Redirect URI**: Enter the below redirect URIs

* For My Data Function app: *https://func-iarm-mydata-regionabbr-prd.azurewebsites.net/.auth/login/aad/callback*
...
1. **Add Additional Redirect URI:** Under the Web platform, click on**Add URI**.
...
* Ensure the Certificate is in **.cer** format.![](data:image/png;base64...)
* Once you click "Add" and the process is complete, you'll see a page like the one below, where you can view the thumbprint of the certificate you uploaded.![](data:image/png;base64...)
...
1. **Configure Token Audiences**:
   * Click on ![](data:image/png;base64...)and add the **Allowed token audiences** starting with api:// and paste the Application (client) ID after api://.
...
1. **Navigate to Your Function App**: Use the search bar to find URC Function App (func-iarm-urc-regionabbr-prd) and select it.
2. **Go to Identity**: In the left-hand menu, click on **Identity** under the **Settings** section.
3. **Click on the Azure Role Assignments Button**: Click on the **Azure role assignments** button.
